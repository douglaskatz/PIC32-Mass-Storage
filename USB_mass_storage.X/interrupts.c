...
/****************************************************************************
  Function:
    void __ISR(_CHANGE_NOTICE_VECTOR, ipl2) _ChangeNoticeHandler(void)

  Description:
    Change Notice (CN) ISR.  This routine is called when a change occures on 
    one of the configured CN ports.
  ...
  Remarks:
    None
  ***************************************************************************/
void __ISR(_CHANGE_NOTICE_VECTOR, ipl4) _ChangeNoticeHandler(void)
{
    unsigned int temp;
    ...
    // Set the flag to indicate the switch has been pressed.
    commandEntrySwitchPressed = TRUE;
