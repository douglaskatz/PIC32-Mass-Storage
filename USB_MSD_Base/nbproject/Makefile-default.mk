...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/USB_MSD_Base.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED="../Microchip/MDD File System/FSIO.c" ../Microchip/USB/usb_host.c "../Microchip/USB/MSD Host Driver/usb_host_msd.c" "../Microchip/USB/MSD Host Driver/usb_host_msd_scsi.c" ../usb_config.c main.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/_ext/2054364014/FSIO.o ${OBJECTDIR}/_ext/343710134/usb_host.o ${OBJECTDIR}/_ext/131683717/usb_host_msd.o ${OBJECTDIR}/_ext/131683717/usb_host_msd_scsi.o ${OBJECTDIR}/_ext/1472/usb_config.o ${OBJECTDIR}/main.o
POSSIBLE_DEPFILES=${OBJECTDIR}/_ext/2054364014/FSIO.o.d ${OBJECTDIR}/_ext/343710134/usb_host.o.d ${OBJECTDIR}/_ext/131683717/usb_host_msd.o.d ${OBJECTDIR}/_ext/131683717/usb_host_msd_scsi.o.d ${OBJECTDIR}/_ext/1472/usb_config.o.d ${OBJECTDIR}/main.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/_ext/2054364014/FSIO.o ${OBJECTDIR}/_ext/343710134/usb_host.o ${OBJECTDIR}/_ext/131683717/usb_host_msd.o ${OBJECTDIR}/_ext/131683717/usb_host_msd_scsi.o ${OBJECTDIR}/_ext/1472/usb_config.o ${OBJECTDIR}/main.o

# Source Files
SOURCEFILES=../Microchip/MDD File System/FSIO.c ../Microchip/USB/usb_host.c ../Microchip/USB/MSD Host Driver/usb_host_msd.c ../Microchip/USB/MSD Host Driver/usb_host_msd_scsi.c ../usb_config.c main.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/USB_MSD_Base.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/USB_MSD_Base.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -mdebugger -D__MPLAB_DEBUGGER_PK3=1 -mprocessor=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/USB_MSD_Base.${IMAGE_TYPE}.${OUTPUT_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}           -mreserve=data@0x0:0x1FC -mreserve=boot@0x1FC00490:0x1FC00BEF  -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,--defsym=__MPLAB_DEBUGGER_PK3=1,--defsym=_min_heap_size=8192,-L"../../../MPLAB C32 Suite/lib",-L"../../../MPLAB C32 Suite/pic32mx/lib",-L".",-Map="${DISTDIR}/USB_Host_-_MSD_-_Simple_Demo_.X.${IMAGE_TYPE}.map",--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/USB_MSD_Base.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -mprocessor=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/USB_MSD_Base.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}          -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--defsym=_min_heap_size=8192,-L"../../../MPLAB C32 Suite/lib",-L"../../../MPLAB C32 Suite/pic32mx/lib",-L".",-Map="${DISTDIR}/USB_Host_-_MSD_-_Simple_Demo_.X.${IMAGE_TYPE}.map",--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml
	${MP_CC_DIR}\\xc32-bin2hex dist/${CND_CONF}/${IMAGE_TYPE}/USB_MSD_Base.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} 
endif
